...
NDiplomacy = {
	...
	FABRICATE_CLAIMS_SLOWDOWN_IF_DISCOVERED = 0.25, -- Instead of 1, this many "days" will be added per day if fabrication has been discovered. I.e. 0.25 means it will take 4x the regular amount time.
